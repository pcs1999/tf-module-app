    ...
    "Statement": [
      {
        ...
        "Resource" : [
          ...
          "arn:aws:ssm:us-east-1:261454514620:parameter/nexus*",
          "arn:aws:ssm:us-east-1:261454514620:parameter/${var.env}.docdb*",
          "arn:aws:ssm:us-east-1:261454514620:parameter/${var.env}.elastic**",
          "arn:aws:ssm:us-east-1:261454514620:parameter/${var.env}.rds*",
          "arn:aws:ssm:us-east-1:261454514620:parameter/${var.env}.rabbitmq*",
